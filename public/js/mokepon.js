...
const sections = { registro:$('registro-jugador'), activacion:$('activar-cuenta'), recuperacion:$('recuperar-cuenta'), lobby:$('seleccionar-sala'), guardian:$('seleccionar-mascota'), mapa:$('ver-mapa'), batalla:$('seleccionar-ataque') }
